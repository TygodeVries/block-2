...
if(death_cooldown > 0)
{
	...
	var ob = instance_create_layer(x + (_x * 48) - 32, (y + _y * 48) - 64, "Instances", obj_trail);
...
{
	sprite_index = animation_falling;
	image_index = 3;	
	image_speed = 0;
}
